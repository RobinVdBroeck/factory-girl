...
`factory-girl` is a factory library for [Node.js](http://nodejs.org/) inspired by [Factory_girl](http://github.com/thoughtbot/factory_girl). It works asynchronously and supports associations and the use of functions for generating attributes.
